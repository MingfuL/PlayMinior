...
import com.example.mingfliu.waveviewplay.douyinlike.TwitterStyleLike;
import com.example.mingfliu.waveviewplay.mini.MinionView;

public class MainActivity extends AppCompatActivity {

    TwitterStyleLike twitterStyleLike;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        twitterStyleLike = findViewById(R.id.like_button);
        twitterStyleLike.setContent("98");
        twitterStyleLike.startAnimate();

        twitterStyleLike.setOnClickListener(new View.OnClickListener() {
            @Override
